    ...
    return (
        <View
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, alignItems: "center", gap: 40, paddingTop: 50 }}>
                ...
                <TextInput onChangeText={(val) => setName(val)} placeholder='Enter your names' style={{ color: "black", backgroundColor: "white", width: 300, height: 50, padding: 10, borderRadius: 10 }} />
                <Button title='Click me' onPress={() => Alert.alert("Oh no!", `You have been added to the orgy! ${name}`, [
                    { text: 'Join Orgy' }
